...
UE.plugins["ecimage"] = function () {
    var me = this,
        images;
    me.commands['ecimage'] = {
        execCommand: function () {
            parent.openWindow("图片选择", "Upload/PicUpload.aspx?type=ck&ckid=" + me.key, { shadow: false, modal: false });
        }
    };
};
var baidu = baidu || {};
...
(function () {
    ...
    var btnCmds = ['ecimage','undo', 'redo', 'formatmatch',
